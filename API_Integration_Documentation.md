...
**Base URL:** `http://69.62.114.202:5009`

**Tam URL:** `http://69.62.114.202:5009/api/v1/products-stock/integration/store?store={mağaza_adı}`
...
```bash
curl -X GET "http://69.62.114.202:5009/api/v1/products-stock/integration/store?store=gosport"
```

### 2. PowerShell ilə İstək

```powershell
Invoke-WebRequest -Uri "http://69.62.114.202:5009/api/v1/products-stock/integration/store?store=gosport" -Method GET
```

### 3. JavaScript (Fetch API) ilə İstək

```javascript
fetch('http://69.62.114.202:5009/api/v1/products-stock/integration/store?store=gosport')
...
url = "http://69.62.114.202:5009/api/v1/products-stock/integration/store"
...
```
✗ Yanlış: http://69.62.114.202:5009/api/v1/products-stock/integration/store
✓ Düzgün: http://69.62.114.202:5009/api/v1/products-stock/integration/store?store=gosport
```
...
async function syncStoreProducts(storeName) {
  try {
    const response = await fetch(
      `http://69.62.114.202:5009/api/v1/products-stock/integration/store?store=${storeName}`
    );
...
async function compareStorePrices(stores) {
  ...
  for (const store of stores) {
    const response = await fetch(
      `http://69.62.114.202:5009/api/v1/products-stock/integration/store?store=${store}`
    );
    const data = await response.json();
...
1. Server-in işlədiyini yoxlayın: `http://69.62.114.202:5009/test`
