...
const ScraperList = () => {
  ...
  const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'http://69.62.114.202:5009/api/v1';
  const WS_BASE_URL = import.meta.env.VITE_WS_BASE_URL || 'http://69.62.114.202:5009';
