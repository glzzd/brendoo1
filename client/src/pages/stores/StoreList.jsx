...
const StoreList = () => {
  ...
  const fetchStores = async (page = 1) => {
    try {
      ...
      const response = await fetch(`http://69.62.114.202:5009/api/v1/store?${queryParams}`, {
        method: "GET",
        headers: {
  ...
  const handleStatusChange = async (storeId, newStatus) => {
    try {
      const response = await fetch(`http://69.62.114.202:5009/api/v1/store/${storeId}/status`, {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
  ...
  const confirmDeleteStore = async () => {
    ...
    try {
      if (deletingStoreId === "bulk") {
        const response = await fetch("http://69.62.114.202:5009/api/v1/store/bulk-delete", {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
        ...
        const response = await fetch(`http://69.62.114.202:5009/api/v1/store/${deletingStoreId}`, {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
